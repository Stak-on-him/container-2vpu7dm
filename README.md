...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2vpu7dm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2vpu7dm.containers.anotherwebservice.com/
...
```
git clone git@github.com:Stak-on-him/container-2vpu7dm.git
cd container-2vpu7dm
```
...
```
docker attach container-2vpu7dm
```
